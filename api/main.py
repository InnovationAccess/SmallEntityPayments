...
from api.routers import ai_assistant, assignments, citations, entity_status, etl_log, litigation, mdm, prosecution, query, sec_leads
...
app.include_router(etl_log.router)
app.include_router(sec_leads.router)
